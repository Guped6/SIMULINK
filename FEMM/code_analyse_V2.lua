...
-- Convention force:
--  +1 => on garde le signe FEMM (TON CHOIX: courant + => Fz peut être négative)
--  -1 => inverse le signe si tu veux changer de convention plus tard
FORCE_SIGN = 1
...
function solve_get_flux_force()
    ...
    -- IMPORTANT: pas de abs(). On conserve le signe (sinon Kb devient faux).
    Fz = FORCE_SIGN * Fz
